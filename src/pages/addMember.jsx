        ...
        <div className="post-content">
          ...
          <div className="breadcamp">
            <ul className="d-flex flex-wrap justify-content-center align-items-center">
              ...
              <li>
                <a href='google' className="active">Add Member</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="col-lg-8 col-12">
          <div className="contact-part">
            ...
            <div className="contact-form d-flex flex-wrap justify-content-between">
              ...
              <input type="text" name="name" placeholder="DoA" />
              <input type="text" name="name" placeholder="special Date" />
              <input type="tel" name="name" placeholder="Mobile Number" />
              <input className="btn" type="submit" defaultValue="Add" />
            </div>
          </div>
        </div>
