...
const gallery2 = () => {
  return (
           ...
           <div className="post-content">
             ...
             <div className="breadcamp">
               <ul className="d-flex flex-wrap justify-content-center align-items-center">
                 ...
                 <li>
                   <a href='google' className="active">Gallery Masonry full-width</a>
                 </li>
               </ul>
             </div>
           </div>
     ...
     <div className="portfolio style-3 padding-tb">
         ...
         <div className="portfolio-wrapper">
           ...
           >
             <div className="post-thumb-inner">
               <a
                 ...
                 href="assets/images/portfolio/17.jpg"
                 data-rel="lightcase"
               >
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/18.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/19.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/24.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/25.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/26.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/27.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
           ...
           >
             <div className="post-thumb-inner">
               <a
                 className="gallery-icon"
                 href="assets/images/portfolio/28.jpg"
                 data-rel="lightcase"
               >
                 <i className="fas fa-link" />
               </a>
